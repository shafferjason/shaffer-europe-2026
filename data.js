  ...
  days: [
    ...
    },
    {
      ...
      photos: [
        ...
        { src: "images/gen-puddle.jpg",             cap: "Wet cobbles and a puddle, the rain just easing off" },
        { src: "images/gen-alley.jpg",              cap: "Down one of the old-town alleys, the caruggi" },
        { src: "images/gen-alley2.jpg",             cap: "Another old-town lane, shops tucked in on either side" },
        { src: "images/gen-strada-nuova.jpg",       cap: "The old street of noble palaces — the Strada Nuova" },
        { src: "images/gen-palazzo-room.jpg",       cap: "Inside the Royal Palace — gilded rooms and mirrors" },
        { src: "images/gen-palazzo-mirrors.jpg",    cap: "The Royal Palace's hall of mirrors under a painted ceiling" },
        { src: "images/gen-san-lorenzo.jpg",        cap: "The Cathedral of San Lorenzo — black-and-white striped stone" },
        { src: "images/gen-cathedral-square.jpg",   cap: "San Lorenzo and its busy square" },
        ...
        { src: "images/gen-lookout.jpg",            cap: "The climb paid off — Genoa spread out below" },
        { src: "images/gen-lookout-harbor.jpg",     cap: "From the lookout, the rooftops down to the harbor" },
        { src: "images/gen-galleon.jpg",            cap: "A wooden galleon moored in the old harbor" },
    ...
    },
    {
      ...
      title: "A morning in Marseille, a night in Paris.",
      mural: "images/mural-day-11.jpg",
      summary: "Off the ship and into the Old Port — a pastry breakfast, a wander through the Panier, a character of a cabbie to the airport, a flight north, and a late Paris bistro dinner.",
      photos: [
        { src: "images/mrs-port-basilica.jpg",     cap: "Marseille's Old Port, Notre-Dame de la Garde up on the hill" },
        { src: "images/mrs-mirror.jpg",            cap: "The mirrored canopy over the Old Port" },
        { src: "images/mrs-mirror-reflection.jpg", cap: "Look up at the canopy and everyone below appears overhead" },
        { src: "images/mrs-panier.jpg",            cap: "A lane in the Panier, Marseille's old quarter" },
        { src: "images/mrs-shutters.jpg",          cap: "Weathered shutters in the old town" },
        { src: "images/mrs-basilica-trees.jpg",    cap: "Notre-Dame de la Garde, framed through the trees" },
        { src: "images/mrs-charite.jpg",           cap: "An old domed building, flags out front" },
        { src: "images/mrs-major.jpg",             cap: "La Major — the striped cathedral down by the water" },
        { src: "images/mrs-major-us.jpg",          cap: "Us at La Major — our cabbie's handiwork" },
        { src: "images/mrs-us.jpg",                cap: "On the waterfront esplanade" },
        { src: "images/par-arc.jpg",               cap: "The Arc de Triomphe, Paris" },
        { src: "images/par-market.jpg",            cap: "A market street near the Champs-Élysées" },
        { src: "images/par-monceau.jpg",           cap: "The colonnade and pond at Parc Monceau" },
        { src: "images/par-monceau-bridge.jpg",    cap: "The little stone bridge at Parc Monceau" },
      ],
      audio: null,
      journal: "Getting off the ship and over to the Old Port took longer than we expected — the boat ride in, the bags, finding the lockers to stow them. By the time we were free we'd lost more of the morning than we'd planned. We started where we always seem to start: a pastry shop, where we filled up on a half dozen things split between us. Then we wandered. We'd meant to take the little train up to the basilica on the hill, but we were short on time, so we let that go and just walked — the Old Port and its big mirrored canopy, the Panier with its alleys and shutters — poking into shops along the way.\n\nWhen it was time to go, we pulled the bags out of storage and grabbed a taxi to the airport, and the driver was a character. He stopped at the striped cathedral so we could get a few pictures, then offered to take ours — even picked out a second spot and lined up a couple more. He was confident about it. A photographer he is not. I deleted most of them, but a few survived. Back in the car he asked what music we wanted; we had no preference, so he chose, and what he chose was Lionel Richie's 'All Night Long,' on a loop. He drove with a lead foot, blowing past traffic at over 120 in a 90 zone. We made it to the airport in about three All Night Longs.\n\nWe flew up to Paris, and the taxi from the airport into the city took almost an hour in traffic. We made up for the sitting once we got there — we walked enough that our mileage matched the day before, just a lot flatter. The Arc de Triomphe, a market street, the columns and the little stone bridge at Parc Monceau.\n\nWe ended the night with a late dinner at a bistro just down the street from the hotel. We'd barely sat down when we caught the music playing — Lionel Richie, 'All Night Long,' again. Out the window, across the street, a young couple was saying goodbye and taking their time about it: they'd embrace, kiss, pull apart, talk a while, then start the whole thing over. It went on a good half hour from when we first noticed, until they finally managed to break away and head off in opposite directions.",
      context: {
      ...
      plan: [
        { time: "9:00 AM",  text: "Disembark in Marseille — slow off the ship and over to the Old Port, then stow the bags." },
        { time: "Morning",  text: "Pastry breakfast, then wandering the Old Port, the Panier, and La Major. Skipped the hilltop basilica — short on time." },
        { time: "Midday",   text: "Taxi to the airport — a character of a driver, 'All Night Long' on a loop, a lead foot." },
        { time: "Afternoon", text: "Flight north to Paris; nearly an hour in traffic into the city." },
        { time: "Evening",  text: "A long flat walk — Arc de Triomphe, a market street, Parc Monceau — then a late bistro dinner." },
      ],
      smallFind: {
        number: "10",
        label: "Looking up to see down",
        text: "At the head of the Old Port there's a giant polished-steel canopy, and the trick of it is the underside is a mirror. Point your phone up and the whole crowd beneath it appears overhead, as if you're looking straight down on everyone. We stood under it a while, watching the street from above.",
        photo: "images/mrs-mirror-reflection.jpg"
      },
      postcardTo: { to: "", text: "", signoff: "" },
      meals: [
        { place: "", dish: "A half-dozen pastries from a Marseille shop, split between us", when: "Morning", cost: "" },
        { place: "", dish: "Late dinner at a bistro down the street from the hotel", when: "Night", cost: "" },
      ],
    },
    {
      id: "day-12",
      ...
      photos: [
        { src: "images/nor-omaha-braves.jpg",     cap: "'Les Braves' — the steel memorial rising from Omaha Beach" },
        { src: "images/nor-omaha-braves2.jpg",    cap: "The curved blades of 'Les Braves,' up close" },
        { src: "images/nor-omaha-beach.jpg",      cap: "Omaha Beach, wide and quiet under a breaking sky" },
        { src: "images/nor-omaha-bluffs.jpg",     cap: "The bluffs above Omaha, old beach obstacles still in the sand" },
        { src: "images/nor-omaha-memorial.jpg",   cap: "The Omaha Beach memorial — the Allied landing, 6 June 1944" },
        { src: "images/nor-pdh-cliffs.jpg",       cap: "Pointe du Hoc — barbed wire and the cliffs the Rangers climbed" },
        { src: "images/nor-pdh-bunker-view.jpg",  cap: "The cliffs framed from inside a German bunker" },
        { src: "images/nor-pdh-gun.jpg",          cap: "A German gun, still pointed out to sea" },
        { src: "images/nor-pdh-casemate.jpg",     cap: "A shattered German casemate" },
        { src: "images/nor-msm-mount.jpg",        cap: "Mont Saint-Michel rising from the bay at low tide" },
        { src: "images/nor-msm-bay.jpg",          cap: "The vast tidal flats, seen from the ramparts" },
        { src: "images/nor-msm-archangel.jpg",    cap: "The golden archangel on the spire, three hundred feet up" },
        { src: "images/nor-msm-nave.jpg",         cap: "Inside the abbey church" },
        { src: "images/nor-msm-house.jpg",        cap: "A timber-framed house in the village lane" },
        { src: "images/nor-msm-garden.jpg",       cap: "A cloister garden, the bay beyond" },
        { src: "images/nor-msm-gull.jpg",         cap: "A gull nesting on the thousand-year-old stone" },
      ],
      audio: null,
      journal: "The longest day of the trip, and a heavy one. The bus pulled out at seven in the morning and didn't bring us back until half past ten that night — fifteen hours on the road, taking in the D-Day coast.\n\nWe started at Omaha Beach, wide and quiet at low tide, with the steel 'Les Braves' memorial rising out of the sand and a stone marker to the men who landed here. Then on to Pointe du Hoc, where the cliffs are still cratered from the bombardment and the German bunkers still stand, the barbed wire rusting right at the edge of the drop the Rangers climbed.\n\nFrom the beaches it was a long ride west across Normandy to Mont Saint-Michel, the abbey on its rock rising out of the bay as the day wound down — the village lanes, the great church, the golden archangel up on the spire. (We passed a wartime reenactment camp on the way out, but didn't stop.)\n\nA lot of ground, a lot of history, and a day we felt in our feet.",
      context: {
        about: "Two icons in a single long day. Normandy's beaches — Omaha, Utah, Gold, Juno, Sword — were the site of the Allied landings on June 6, 1944, the start of the liberation of western Europe. Then west to Mont Saint-Michel, a medieval abbey on a tidal island rising from the bay — UNESCO since 1979, monastic since the 8th century.",
        timing: "Two days before the 82nd anniversary of D-Day (June 6, 1944). Memorial events, gatherings, and ceremonies will be ramping up across the beaches as we visit. Veterans and families come back every year — fewer of the original Allied soldiers left each anniversary.",
      ...
      smallFind: {
        number: "11",
        label: "The wheel the prisoners walked",
        text: "When Mont Saint-Michel was a prison, convicts powered this giant wooden treadmill wheel — walking inside it like a hamster to haul sledges of supplies up the steep rock from the foot of the Mount.",
        photo: "images/nor-msm-wheel.jpg"
      },
      postcardTo: { to: "", text: "", signoff: "" },
      meals: [],
    },
